...
const VIDEOS = [
  {
    num: 'Project 01',
    title: ['Motion Design Ad –', 'Cozy Mattress'],
    desc: 'Motion design product video for a mattress brand – high-performing ad creative for e-commerce.',
    vimeoId: '1213564603',
    tags: ['Motion Design', 'Amazon', 'Shopify', 'Kickstarter'],
  },
  {
    num: 'Project 02',
    title: ['Motion Design Ad –', 'Steel Water Bottle'],
  ...
  {
    num: 'Project 03',
    title: ['Motion Design Ad –', 'Keyboard'],
    desc: 'Motion design ad creative for a keyboard brand – scroll-stopping and high-performing on TikTok & more.',
    vimeoId: '1213564029',
    tags: ['Motion Design', 'Ad Creative', 'TikTok', 'E-Commerce'],
  },
  {
    num: 'Project 04',
    title: ['Sponsored Brands Ad –', 'Beauty Seller'],
    desc: 'High-quality Sponsored Brands video ad for an Amazon beauty seller. ACoS -28% after 4 weeks.',
    vimeoId: '1213563594',
    tags: ['Amazon Ads', 'Beauty', 'Sponsored Brands'],
  },
  {
    num: 'Project 05',
    title: ['AI Content Pipeline –', 'Business Coach'],
    desc: 'Fully automated content pipeline for a business coach on LinkedIn – fresh content every day, zero effort.',
    vimeoId: '1213563562',
    tags: ['LinkedIn', 'AI Pipeline', 'Automation'],
  },
];
