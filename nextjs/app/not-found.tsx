  ...
  return (
    <div className="flex min-h-screen flex-col bg-black text-white">
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 pt-[94px] text-center">
        <div className="mb-6 text-[11px] font-bold uppercase tracking-[1.2px] text-violet-300">Error 404</div>
        <h1 className="mb-4 text-[clamp(32px,5vw,56px)] font-black leading-[1.05]">
          This page doesn&apos;t <span className="text-violet-300">exist.</span>
        </h1>
        ...
        <a
          href="/"
          className="rounded-[10px] bg-violet-400 px-8 py-3.5 text-[15px] font-bold text-black shadow-[0_4px_20px_rgba(167,139,250,0.35)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(167,139,250,0.5)]"
        >
          Back to homepage →
        </a>
      </main>
