      ...
      <div className="relative z-[2] flex w-full max-w-[1240px] flex-wrap justify-between gap-10">
        <div className="max-w-[340px]">
          <div className="mb-4 flex items-center gap-2">
            <div className="text-[17px] font-extrabold tracking-normal text-violet-300 [text-shadow:0_0_18px_rgba(196,181,253,0.55),0_0_36px_rgba(139,92,246,0.3)]">
              LaunchYourProduct
            </div>
          </div>
          ...
          <a
            ...
            className="mt-[22px] inline-block rounded-[10px] bg-violet-400 px-6 py-3 text-sm font-bold text-black shadow-[0_4px_20px_rgba(167,139,250,0.35)]"
          >
            Free Audit →
          </a>
        </div>
        ...
        <div className="flex flex-wrap gap-14">
          <div>
            ...
            <a href="#how" className="mb-2.5 block text-sm text-white/50 transition-colors hover:text-violet-300">UGC-Style Hooks</a>
            <a href="#how" className="mb-2.5 block text-sm text-white/50 transition-colors hover:text-violet-300">Showcase Videos</a>
            <a href="#how" className="mb-2.5 block text-sm text-white/50 transition-colors hover:text-violet-300">Sponsored Brands Ads</a>
          </div>
          <div>
            <h5 className="mb-3.5 text-[11px] font-bold uppercase tracking-[1.5px] text-white/35">Company</h5>
            <a href="#about" className="mb-2.5 block text-sm text-white/50 transition-colors hover:text-violet-300">About</a>
            <a href="#portfolio" className="mb-2.5 block text-sm font-bold text-violet-300">→ Portfolio</a>
            <a href="#how" className="mb-2.5 block text-sm text-white/50 transition-colors hover:text-violet-300">How it works</a>
          </div>
          <div>
            <h5 className="mb-3.5 text-[11px] font-bold uppercase tracking-[1.5px] text-white/35">Legal</h5>
            <a href="/imprint" className="mb-2.5 block text-sm text-white/50 transition-colors hover:text-violet-300">Imprint</a>
            <a href="/privacy-policy" className="mb-2.5 block text-sm text-white/50 transition-colors hover:text-violet-300">Privacy Policy</a>
            <a href="/terms" className="mb-2.5 block text-sm text-white/50 transition-colors hover:text-violet-300">Terms &amp; Conditions</a>
          </div>
        </div>
      </div>

      <div
        className="relative z-[1] select-none text-center font-black leading-[0.8] tracking-[-0.5px] text-violet-300 opacity-90"
        style={{
