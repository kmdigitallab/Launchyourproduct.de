      ...
      <div className="mx-auto max-w-[860px]">
        <Reveal className="mb-14 text-center">
          <h2 className="mb-4 text-[clamp(26px,3.2vw,44px)] font-extrabold leading-[1.1] tracking-normal text-white">
            About <span className="text-violet-300">us.</span>
          </h2>
        ...
        <Reveal className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          <div className="rounded-xl border border-white/10 bg-white/[0.03] p-7">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-violet-400/10 text-xl font-black text-violet-300">
              T
            </div>
